...
echo "==> soph1e_ra1n Loader App Builder"
echo ""
...
TOOL_NAME = soph1e_ra1n_loader
soph1e_ra1n_loader_FILES = main.m
soph1e_ra1n_loader_CFLAGS = -fobjc-arc
soph1e_ra1n_loader_CODESIGN_FLAGS = -S entitlements.plist
