...
echo "============================================"
echo " soph1e ra1n Full Jailbreak Script"
echo "============================================"
echo ""
...
# Check for bootstrap
BOOTSTRAP_TAR="$DEVICE_DIR/bootstrap/build/soph1e ra1n-bootstrap-1.0.0.tar.gz"
...
# Step 1: Run exploit
echo ""
echo "[1/6] Running soph1e ra1n exploit..."
python3 -m soph1e_ra1n exploit || {
    echo "Exploit failed"
    exit 1
}
...
# This would use soph1e ra1nctl to boot a custom ramdisk image
# python3 -m soph1e ra1nctl boot ramdisk.iBoot
...
# ssh root@device "tar -xzf soph1e ra1n-bootstrap-1.0.0.tar.gz -C /"
...
echo " The soph1e ra1n Loader app is on your"
