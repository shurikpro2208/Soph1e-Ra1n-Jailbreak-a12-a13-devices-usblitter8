...
def print_header():
    ...
    print("  soph1e ra1n - A12/A13 SecureROM Jailbreak")
...
class InteractiveTUI:
    ...
    def flash_board(self):
        ...
        if not fw_path:
            ...
            animated_status("Run 'Fetch firmware' from menu or 'soph1e-ra1n fetch-firmware'")
            wait_for_key()
            return
    ...
    def fetch_firmware(self):
        ...
        try:
            ...
            req = urllib.request.Request(url, headers={"User-Agent": "soph1e-ra1n"})
